...
class ServiceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $services = [
            [
                'thumbnail' => $imageHelper->createDummyImageWithTextSizeAndPosition(372, 230, 'center'),
        ...
        foreach ($services as $service) {
            ...
            for ($i = 0; $i < rand(1, 5); $i++) {
                ...
                $serviceImage->image = $imageHelper->createDummyImageWithTextSizeAndPosition(370, 240, 'center')->store('assets/services/images', 'public');
                $serviceImage->save();
            }
        }
    }
