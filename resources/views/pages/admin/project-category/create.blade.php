<x-layouts.admin title="Tambah Project Category">

    <x-ui.breadcumb-admin>
        <li class="breadcrumb-item"><a href="{{ route('admin.project-category.index') }}">Project Category</a></li>
        <li class="breadcrumb-item active" aria-current="page">Tambah Project Category</li>
    </x-ui.breadcumb-admin>
    ...
    <div class="row">
        ...
        <div class="col-md-12 grid-margin stretch-card">
            <x-ui.base-card>
                <x-slot name="header">
                    <h4 class="card-title">Tambah Project Category</h4>
                </x-slot>
